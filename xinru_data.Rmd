...
plot(density(sub_1$survey_outcome),xlab = "",main = "Density of survey score when latent state is nondisease")
lines(x=c(mean(sub_1$survey_outcome),mean(sub_1$survey_outcome)),y=c(-0.5,0.6),col="red",lty=2)
plot(density(sub_2$survey_outcome),xlab = "",main = "Density of survey score when latent state is nondisease")
...
plot(density(sub_1$call_counts),xlab = "",main = "Density of call counts when latent state is nondisease")
lines(x=c(mean(sub_1$call_counts),mean(sub_1$call_counts)),y=c(-0.5,0.6),col="red",lty=2)
plot(density(sub_2$call_counts),xlab = "",main = "Density of call counts when latent state is nondisease")
...
plot(density(sub_1$text_counts),xlab = "",main = "Density of text counts when latent state is nondisease")
lines(x=c(mean(sub_1$text_counts),mean(sub_1$text_counts)),y=c(-0.5,0.6),col="red",lty=2)
plot(density(sub_2$text_counts),xlab = "",main = "Density of text counts when latent state is disease")
...
plot(density(sub_1$duration),xlab = "",main = "Density of duration when latent state is nondisease")
lines(x=c(mean(sub_1$duration),mean(sub_1$duration)),y=c(-0.5,0.6),col="red",lty=2)
plot(density(sub_2$duration),xlab = "",main = "Density of duration when latent state is disease")
